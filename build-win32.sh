...
tools/rcedit-x64 native-win32/TheNightmatez.exe \
  --application-manifest packr/runelite.manifest \
  --set-icon runelite.ico

echo TheNightmatez.exe 32bit sha256sum
sha256sum native-win32/TheNightmatez.exe

dumpbin //HEADERS native-win32/TheNightmatez.exe
