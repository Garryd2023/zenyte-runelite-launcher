...
tools/rcedit-x64 native-win32/TheCErver.exe \
  --application-manifest packr/runelite.manifest \
  --set-icon runelite.ico

echo TheCErver.exe 32bit sha256sum
sha256sum native-win32/TheCErver.exe

dumpbin //HEADERS native-win32/TheCErver.exe
