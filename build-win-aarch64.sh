...
tools/rcedit-x64 native-win-aarch64/TheNightmatez.exe \
  --application-manifest packr/runelite.manifest \
  --set-icon runelite.ico

echo TheNightmatez.exe aarch64 sha256sum
sha256sum native-win-aarch64/TheNightmatez.exe

dumpbin //HEADERS native-win-aarch64/TheNightmatez.exe
